...
export const SET_PUBLISH_CONTEXTS = actionScaffold({
	...
	idempotent: true,
	doc: `Sets the \`cpn-publish-contexts\` frontmatter. Supply the contexts per option via a step \`params.contexts\`, e.g.:

\`\`\`
- { action: "[[set-publish-contexts]]", params: { contexts: ["public", "amazon"] } }
\`\`\`
